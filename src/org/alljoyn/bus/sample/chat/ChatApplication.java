...
public class ChatApplication extends Application implements Observable {
	 ...
	 */
	public synchronized void newLocalUserMessage(Object message) {
	 ...
	 */
	public synchronized void newRemoteUserMessage(String nickname, Object message) {
	 ...
	 */
	private List<Object> mOutbound = new ArrayList<Object>();
	 ...
	 */
	private void addOutboundItem(Object message) {
	 ...
	 * sent.
	 */
	public synchronized Object getOutboundItem() {
	 ...
	 */
	private void addInboundItem(String nickname, Object message) {
	 ...
	 */
	private List<Object> mHistory = new ArrayList<Object>();
	//public static List<String> mHistory = new ArrayList<String>();
	 ...
	 */
	private void addHistoryItem(String nickname, Object message) {
    ...
    public synchronized List<Object> getHistory() {
        List<Object> clone = new ArrayList<Object>(mHistory.size());
        for (Object string : mHistory) {
            clone.add(string);
        }
        return clone;
    }
